...
public class CreditsButton extends Button {
    public CreditsButton(){
        Image exitImage = new Image("Images/Menu Screen/Creditst_buttons.png", Settings.height /5.0,Settings.height/5.0,true,false);
        Image exitImageOnHover = new Image("Images/Menu Screen/Creditst_buttons_pressed.png",Settings.height/5.0,Settings.height/5.0,true,false);
